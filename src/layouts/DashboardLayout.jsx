...
export default function DashboardLayout() {
  const { user, signOut, bypassAuth, toggleAuthBypass } = useAuth()
      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-10">
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-4 border-b">
            <h1 className="text-xl font-bold text-primary-600">Meducate</h1>
            <p className="text-sm text-gray-500">SEO & Analytics Optimizer</p>
          </div>
